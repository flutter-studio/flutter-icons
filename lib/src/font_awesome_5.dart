...
class FontAwesome5 {
  ...
  static hasIconData(iconName, {IconWeight weight}) {
    switch (weight) {
      case IconWeight.Brand:
        return _fontAwesome5_meta["brands"].contains(iconName);
      case IconWeight.Solid:
        return _fontAwesome5_meta["solid"].contains(iconName);
      default:
        return _fontAwesome5_meta["regular"].contains(iconName);
    }
  }
}
